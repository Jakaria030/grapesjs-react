const CanvasStyle = (editor) => {
    editor.on('load', () => {
        ...
        @media (max-width: 480px) {
            .cntd-box { min-width: 72px; padding: 16px 18px; }
            .cntd-num { font-size: 36px; }
            .cntd-sep { font-size: 28px; }
        }
        /* ─── HEADER ─────────────────────────────────────────── */
        ...
        @media (max-width: 768px) {
            ...
            .hdr-btn:not(.hdr-mobile-btn) { display: none; }
        }
