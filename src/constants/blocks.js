...
(function() {
    ...
    },
    {
        id: "tailwind-css",
        label: 'Tailwind Hero',
        media: `<img src='/assets/section.png' draggable='false'/>`,
        content: `
    <section class="bg-blue-600 py-20 text-center">
      <h1 class="text-4xl font-bold text-white mb-4">Build with Tailwind</h1>
      <p class="text-blue-100 text-lg">This block uses utility classes directly.</p>
      <button class="mt-6 px-6 py-2 bg-white text-blue-600 rounded-full hover:bg-blue-50 transition-colors">
        Get Started
      </button>
    </section>`
    },
